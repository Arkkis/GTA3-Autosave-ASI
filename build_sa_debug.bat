@echo off
REM Build script for Autosave mod - San Andreas Debug configuration
...
REM Build Debug configuration for San Andreas
echo.
echo Building Autosave mod for San Andreas (Debug configuration)...
"!MSBUILD_PATH!" Autosave.sln /t:Clean,Build /p:Configuration=Debug /p:Platform=SA /v:minimal /nologo
