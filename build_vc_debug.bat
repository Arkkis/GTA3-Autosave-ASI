@echo off
REM Build script for Autosave mod - Vice City Debug configuration
...
REM Build Debug configuration for Vice City
echo.
echo Building Autosave mod for Vice City (Debug configuration)...
"!MSBUILD_PATH!" Autosave.sln /t:Clean,Build /p:Configuration=Debug /p:Platform=VC /v:minimal /nologo
