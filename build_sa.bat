@echo off
REM Build script for Autosave mod - San Andreas Release configuration
...
REM Build Release configuration for San Andreas
echo.
echo Building Autosave mod for San Andreas (Release configuration)...
"!MSBUILD_PATH!" Autosave.sln /t:Clean,Build /p:Configuration=Release /p:Platform=SA /v:minimal /nologo
