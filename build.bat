@echo off
REM Build script for Autosave mod - equivalent to "Build Solution" in Visual Studio
...
echo.
echo Building Autosave mod (Release configuration)...
"!MSBUILD_PATH!" Autosave.sln /t:Clean,Build /p:Configuration=Release /p:Platform=GTA3 /v:minimal /nologo
