@echo off
REM Build script for Autosave mod - Debug configuration
...
echo.
echo Building Autosave mod (Debug configuration)...
"!MSBUILD_PATH!" Autosave.sln /t:Clean,Build /p:Configuration=Debug /p:Platform=GTA3 /v:minimal /nologo
